...
用法：
    ../.venv/bin/python scripts/eval_recruitment.py --mode retrieval
    ../.venv/bin/python scripts/eval_recruitment.py --mode full --limit 10
...
from app.core.retriever import estimate_tokens  # noqa: E402
from app.core.evidence_gate import filter_evidence  # noqa: E402
