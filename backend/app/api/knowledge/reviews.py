...
from app.core.documents.lifecycle.document_publisher import archive_document, publish_document
...
from app.services.knowledge.document_governance import current_version, require_document, transition
...
def publish(doc_id: str, body: DocumentReviewAction, background_tasks: BackgroundTasks,
    ...
    from app.services.knowledge.document_governance import check_lock
...
def rollback_scoped(kb_id: str, doc_id: str, body: DocumentRollbackAction,
    ...
    doc.lock_version += 1
    from app.services.knowledge.document_governance import append_review
