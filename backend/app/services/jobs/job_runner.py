...
def _execute(context: JobContext, job_type: str, payload: dict) -> dict:
    ...
    if job_type == "document_publish":
        from app.core.documents.lifecycle.document_publisher import publish_document
    ...
    if job_type == "evaluation":
        command = [sys.executable, str(ROOT / "backend/scripts/evaluation/eval_recruitment.py"),
