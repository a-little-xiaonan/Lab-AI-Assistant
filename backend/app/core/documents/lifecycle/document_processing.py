...
from app.core.documents.parsing import chunker, document_loader
...
from app.services.knowledge.quality_checker import run_quality_checks
...
def process_document(doc_id: str, target_suffix: str = "docs") -> None:
    ...
    try:
        ...
        try:
            from app.core.retrieval.indexing.topic_suggester import suggest_topics
